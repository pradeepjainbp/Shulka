...
export function EditBusinessForm({ business }: { business: BusinessRow }) {
    ...
    <main className="min-h-screen bg-surface p-6">
      <div className="max-w-lg mx-auto space-y-6">
        ...
        <div className="space-y-1">
          <h1 className="text-2xl font-semibold text-ink">Edit Business</h1>
          <p className="text-sm text-ink-muted">Update your business details.</p>
        </div>
